...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        yeoman: {
            // configurable paths
            version:'0.1.0',
            app: require('./bower.json').appPath || '<%= yeoman.version %>/hj',
            dist: 'dist',
        ...
        less: {
            development: {
                ...
                files: {
                    "<%= yeoman.version %>/.tmp/styles/*.css": "<%= yeoman.app %>/styles/bootstrap.less"
                }
            }
        },
        ...
        express: {
            ...
            dev: {
                options: {
                    script: '<%= yeoman.version %>/hj_server.js'
                }
            },
            dist: {
                options: {
        ...
        autoprefixer: {
            ...
            dist: {
                files: [
                    {
                        expand: true,
                        cwd: '<%= yeoman.version %>/.tmp/styles/',
                        src: '{,*/}*.css',
                        dest: '<%= yeoman.version %>/.tmp/styles/'
                    }
                ]
            }
        },
        ...
        compass: {
            options: {
                ...
                cssDir: '<%= yeoman.version %>/.tmp/styles',
                generatedImagesDir: '<%= yeoman.version %>/.tmp/images/generated',
...
//            'connect:livereload',
    ...
    grunt.registerTask('yuidoc', ['yuidoc:compile']);
